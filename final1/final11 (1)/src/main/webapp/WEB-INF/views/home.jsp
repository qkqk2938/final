        ...
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-slide">
                ...
                <div class="blog-thumbnail">
                    <a href="#"><img src="${path}/resources/img/bg-img/1.jpg" alt=""></a>
                </div>
            ...
            <div class="single-slide">
                <!-- Blog Thumbnail -->
                <div class="blog-thumbnail">
                    <a href="#"><img src="${path}/resources/img/bg-img/2.jpg" alt=""></a>
                </div>
            ...
            <div class="single-slide">
                <!-- Blog Thumbnail -->
                <div class="blog-thumbnail">
                    <a href="#"><img src="${path}/resources/img/bg-img/3.jpg" alt=""></a>
                </div>
    ...
    <div class="big-posts-area mb-50">
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <div class="big-post-thumbnail mb-50">
                        <img src="${path}/resources/img/bg-img/7.jpg" alt="">
                    </div>
                </div>
                <div class="col-12 col-md-6">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="big-post-thumbnail mb-50">
                        <img src="${path}/resources/img/bg-img/8.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-8 col-xl-9">
                    ...
                    <div class="single-blog-post style-1 d-flex flex-wrap mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <img src="${path}/resources/img/bg-img/9.jpg" alt="">
                        </div>
                        <!-- Blog Content -->
                        <div class="blog-content">
                            <a href="#" class="post-tag">The Best</a>
