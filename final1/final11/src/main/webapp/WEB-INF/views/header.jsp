<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/handlebars.js/3.0.1/handlebars.js"></script>
     <style>
   select{height:50px; font-family:"Montserrat", sans-serif; text-align:center; border-radius:5px ; border:1px white;}
   option{height:10px; font-family:"Montserrat", sans-serif; } 
    </style>
<!-- ##### Header Area Start ##### -->
  ...
  <jsp:include page="navi.jsp"/>
        ...
        <div class="top-header-area bg-img bg-overlay" style="height:70px; ">
                                    ...
                                    <li><a href="contact">Contact</a></li>
                                     ...
                                     <c:if test="${gid!= null}">
                                      ...
                                      <li><a href="#">My Page</a>
                                      	<div class="megamenu">
                                      		<ul class="dropdown">
                                      			<li><a href="cmyPage">둘러보기</a></li>
                                      			<li><a href="joinUpdate2">나의 정보 수정</a></li>
                                      		</ul>
                                      	</div>
                                      	</li>
                                      	
                                    <li><a href="insert">Cafe Insert</a></li>
                                     </c:if>
