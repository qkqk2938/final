...
<jsp:include page="header.jsp"/>	   
	...
	<div class="instagram-feed-area d-flex flex-wrap" style="margin-top:100px;">
      ...
      <div >
       <div id="cimage" style="margin:auto;"><img src="display?fileName=cafeimage/${rlist.cimage} " style="width:200px; height:200px; border-radius:100px;" >
      <span id="name" style="font-size:30px;  margin-bottom:100px; margin-left:2%"><b>${rlist.cname}</b></span> 
    </div>
   <div id="gigi" style="margin-top:50px;">
   
       <c:forEach items="${reviewlist}" var="vo">       
      <!-- Single Instagram -->
      <div class="single-instagram" style="margin-right: 70px; margin-top: 70px; float:left;">
         <img src="display?fileName=attach/${vo.rimage}" alt="" style="width:300px; height:300px" >
	...
	<script src="${path}/resources/js/active.js"></script>
      ...
      <div id = "lightbox" style="overflow:hidden">
		<div style="float:left; left:0px; bottom:0px;  ">
			...
			<div id="here" style="height:45%; max-hight:40%; overflow-y: auto;">
            ...
            {{#each .}}
			 ...
			 <span style="margin-left:20px;"><button class="btnGood" style="border:none;background-color: transparent !important;"></button> <br>  <button class = "reviewUpdate" style="background-color: transparent !important;border:none;">  수정</button> / <button class="reviewDelete" style="background-color: transparent !important;border:none;">삭제</button></span>
			<textarea class="rccontent"  cols="30" rows="4" placeholder="Message" style=" margin-top:2%; margin-left:18px; "></textarea>
			
			
			<input type="button" id="btnInsert" style="border:0px; background:white;margin-left:1%; margin-bottom:2% "   value="게시" >
...
$(".reviewDelete").on("click",function(){
	...
	var rcode=$(this).parent().parent().find("#here").find(".rcode").text();
	var ccode=$(".ccode").val();
	...
	$.ajax({
		...
		success:function(){
			alert("삭제되었습니다.");
			location.href="reply?ccode="+ccode;
		}
	});
...
$(".reviewUpdate").on("click",function(){
	...
	location.href="reviewUpdate?rcode="+rcode+"&ccode="+ccode;
