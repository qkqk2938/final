...
<body>
  ...
  <!-- ##### Header Area End ##### -->
	...
	<div class="tab-content container" style="text-align:center; margin:auto;">
		...
		<div style="float:left;margin:10px;">
			...
			<img src="http://placehold.it/200x200" onClick="location.href='/final/read?ccode=${vo.CCODE}'"><br>
			</c:if>
			<c:if test="${vo.CIMAGE!=null}">
			<img src="display?fileName=cafeimage/${vo.CIMAGE}" style="width:200px;height:200px;" onClick="location.href='/final/read?ccode=${vo.CCODE}'"><br>
			</c:if>
			${vo.CNAME}<br>
			조회수 :&nbsp;${vo.VIEWCNT}
			</div>
		...
		<div style="float:left;margin:10px;">
			<c:if test="${v.RIMAGE==null}">
			<img src="http://placehold.it/200x200" onClick="location.href='/final/reply?ccode=${v.CCODE}'"><br>
			</c:if>
			<c:if test="${v.RIMAGE!=null}">
			<div style="width:200px;height:200px;">
			<img  src="display?fileName=attach/${v.RIMAGE}" onClick="location.href='/final/reply?ccode=${v.CCODE}'"><br>
			</div>
			</c:if>
			${v.CNAME}<br>
			평점 :&nbsp;${v.RSCOPE}<br>
		...
		<div style="float:left;margin:10px;">
			<c:if test="${vv.RIMAGE==null}">
			<img src="http://placehold.it/150x120" onClick="location.href='/final/'"><br>
			</c:if>
			<c:if test="${vv.RIMAGE!=null}">
			<img src="display?fileName=${vv.RIMAGE}" onClick="location.href='/final/'"><br>
			</c:if>
			${vv.RCCONTENT}<br>
			${vv.RCDATE}
			</div>
