  ...
  <form name="frm" >
    <table border=1>
      ...
      <tr>
        ...
        <td><input type="password" name="gpass" placeholder="비밀번호를 입력하세요">
        <div id = "lr" style = "color:red;"></div>
            ...
            <tr>
             ...
             <input type="submit" value="login" width=100>
              ...
              <div></div>
                          <span id = "naver_id_login" style="width:100px;margin-right:20px"></span>  
                          <a id="custom-login-btn" href="login_result2"> 
         <img src="display?fileName=kakao.png" style="width:40px;"/>
         </a>
             </td>
             </tr>
