...
public class HomeController {
	...
	public String home(Locale locale, Model model,HttpSession session,Criteria cri) {
		...
		cri.setPerPageNum(5);
		model.addAttribute("home",cmapper.list(cri));
		model.addAttribute("big",cmapper.big());
		model.addAttribute("small",cmapper.small());
	...
	public void category(Model model){
		model.addAttribute("tag",hMapper.hashTag());
		model.addAttribute("ht",hMapper.list());
	}
