  ...
  <!-- ##### Header Area End ##### -->
	...
	<div class="tab-content container" style="text-align:center; margin:auto;">
		...
		<div style="float:left;margin:10px;">
			...
			<img src="http://placehold.it/200x200" onClick="location.href='/final/'"><br>
			</c:if>
			<c:if test="${vo.CIMAGE!=null}">
			<img src="display?fileName=cafeimage/${vo.CIMAGE}" style="width:200px;height:200px;" onClick="location.href='/final/'"><br>
			</c:if>
			${vo.CNAME}<br>
			조회수 :&nbsp;${vo.VIEWCNT}
			</div>
		...
		<div style="float:left;margin:10px;">
			...
			<c:if test="${v.RIMAGE!=null}">
			<img src="display?fileName=attach/${v.RIMAGE}" onClick="location.href='/final/'"><br>
			</c:if>
			${v.CNAME}<br>
			평점 :&nbsp;${v.RSCOPE}<br>
			${v.RCONTENT}<br>
