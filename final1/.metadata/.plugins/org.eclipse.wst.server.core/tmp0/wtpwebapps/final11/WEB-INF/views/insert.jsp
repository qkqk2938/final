...
<jsp:include page="secmenu.jsp"></jsp:include>
  ...
  <div class="catagory-post-area section-padding-100" >
   ...
   <form name="frm" id = "frm" action="insert2" method="post"
      enctype="multipart/form-data">
      <div id="ment"><b>카페 등록</b></div>
      <table>
         <tr style="height:50px;">
            <th width=100>카페이름</th>
            <td width=500><input type="text" placeholder="카페 이름을 입력하세요" name="cname" size=50></td>
         </tr>
         <tr style="height:50px;">
            <th width=100>카페전화번호</th>
            <td width=500><input type="text" placeholder="전화번호를 입력하세요" name="ctel" size=20></td>
         </tr>
         
         <tr style="height:50px;">
            <th>카페 주소</th>
            <td>
               <input type="text" id="address1" placeholder="주소찾기" size=30>
         ...
         <tr style="height:50px;">
            ...
            <td>
         <input id = "menu" placeholder="메뉴" style="margin-right:10px;"><input id = "price"  placeholder="가격" type = number><input type = "button" value="추가" id = "btnaddmenu" style="margin-left:3px;">
         <input type = hidden name="cmenu" id = "cmenu">
            <table id = "addmenu">
            ...
            <tr style="height:100px;">
               <th>카페 소개글</th>
               <td><textarea  name = "ccontent" cols="35" rows="4" placeholder="Message"></textarea></td>
            </tr>
         <tr style="height:120px;">
            <th width=100>대표이미지</th>
            <td width=500>
            <img src = "${path}/resources/img/core-img/camera.png" id = "image" style="width:100px; height:100px;">
...
$(frm.address1).click(function(){
   ...
   $(frm.files).on("change",function(){
      ...
      $.each(files,function(index, file){
         str += "<img class=image2 id=image2 src='"+URL.createObjectURL(file)+"'>";
      });
