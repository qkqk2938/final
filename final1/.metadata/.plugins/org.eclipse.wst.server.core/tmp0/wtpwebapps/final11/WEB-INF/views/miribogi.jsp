  ...
  align-items: center;
	...
	<!-- Initialize Swiper -->
						...
						<div class="blog-content">
							...
							<h4>
								Best Review <button style="float: right; font-size: 13px;background-color: transparent !important;border:none;" onClick="location.href='reply'">더보기<img
				...
				Handlebars.registerHelper("check", function(good) {
					if(good==0){
				   		return "${path}/resources/img/core-img/like_unclick.png";
					}else{
						return "${path}/resources/img/core-img/like_click.png";
					}
				   });
									...
									$.ajax({
										...
										success:function(data){
											...
											$.each(data,function(index,items){
												str += "<img style='margin:10px;' src='display?fileName=attach/"+items+"' width=100>";
					...
					<div class="ingredients">
						...
						<c:forEach items="${menu}" var="menu">
							<div class="custom-control custom-checkbox" style="overflow:hidden;">
								<div style="width:100px;height:85px;float:left;margin-right:30px;"><img style="width:90px;height:90px;" src="display?fileName=${menu.image}"></div>
						...
						<div class="single-widget-area author-widget mb-30">
							<div class="background-pattern bg-img"
								...
								alt=""><span style="font-size: 0.8rem;">리뷰쓰기</span></button>
									<button id="btnFavorite" style="background-color: transparent !important;border:none;"><span id="favorites" style="font-size:29px;">☆</span><span style="font-size: 0.8rem;">즐겨찾기</span></button>
								</div>
							</div>
...
<script>
var listFile = opener.document.querySelector("#listFile");
var list = listFile.querySelectorAll("img");
list.forEach(function(list,index){
	var src = list.src;
	var atr = "<div class='swiper-slide'><img style='height:370px;' src='"+src+"'></div>";
	$(".swiper-wrapper").append(atr);
})
var cimage = opener.document.querySelector("#image").src;
var str= "<img src="+cimage+" alt=''>";
$(".author-thumbnail").html(str);
